...
指定比例：
python split_pkl_dataset.py --input train10w.pkl --output_dir split1 --train_ratio 0.8 --valid_ratio 0.1 --test_ratio 0.1

按 label 分层划分，保持正常/钓鱼比例尽量一致：
python split_pkl_dataset.py --input train10w.pkl --output_dir data/split1 --stratify_label
"""
