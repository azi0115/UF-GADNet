...
class PhishingConfig:  # 项目总配置对象。
    ...
    train_path: str = "data/b_data/data/split1/train.pkl"  # 训练集文件路径，默认使用 pkl。
    val_path: str = "data/b_data/data/split1/valid.pkl"  # 验证集文件路径，默认使用 pkl。
    test_path: str = "data/b_data/data/split1/test.pkl"  # 测试集文件路径，默认使用 pkl。
